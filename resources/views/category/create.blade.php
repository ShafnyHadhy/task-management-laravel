<x-app-layout>
    <div class="max-w-4xl mx-auto px-6 py-10">
        <div class="flex justify-between items-center mb-8">
            <h2 class="text-3xl font-bold text-white flex items-center gap-2">Create New Category</h2>
        ...
        <div class="bg-white shadow-xl rounded-2xl p-8 border border-gray-200 max-w-2xl mx-auto">
            <form action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-8">
                    <button type="submit"
                            class="w-full bg-gray-600 text-white py-3 rounded-lg font-semibold shadow-md hover:bg-gray-800 focus:ring-2 focus:ring-blue-300 transition">
                        🚀 Create Category
                    </button>
                </div>
            </form>
